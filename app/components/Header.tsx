...
export default function Header() {
  ...
  return (
    <header>
      <div className="bg-dark dark:bg-aqua md:px-4 md:py-5 flex flex-col md:flex-row md:items-center fixed md:bottom-0 min-w-full justify-between z-10">
        ...
        <div>
          <div className={`${isOpen? 'flex' : 'hidden'} md:flex flex-col justify-start md:flex-row md:items-center gap-5 text-light font-text text-sm  md:border-none border-solid border-t-4 border-aqua transition-all duration-300`}>
            <nav>
